...
public class Problem0055 {
  ...
  public static void main(String[] args) {
    ...
    Utils.stopwatch(Problem0055::first_try);
  ...
  public static void first_try() {
    ...
    for (int i = 1; i < 10000; i++) {
      ...
      while (count <= 50) {
        ...
        BigInteger b = a.add(new BigInteger(new StringBuilder(a.toString()).reverse().toString()));

        if (b.toString().equals(new StringBuilder(b.toString()).reverse().toString())) {
          palindromic = true;
          break;
        }
